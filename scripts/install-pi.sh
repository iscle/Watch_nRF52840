...
#  Preqrequisites: (Remove folders ~/Watch-rust-mynewt and ~/openocd-spi if they exist)
#  sudo apt install -y wget p7zip-full
#  cd ~
#  wget https://github.com/lupyuen/Watch-rust-mynewt/releases/download/v2.0.2/Watch-rust-mynewt.7z
#  7z x Watch-rust-mynewt.7z
#  rm Watch-rust-mynewt.7z
#  cd ~/Watch-rust-mynewt
...
cp $HOME/openocd-spi/src/openocd $HOME/Watch-rust-mynewt/openocd/bin/openocd
