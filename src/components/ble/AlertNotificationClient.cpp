...
AlertNotificationClient::AlertNotificationClient(Watch::System::SystemTask &systemTask,
...
void AlertNotificationClient::OnNotification(ble_gap_event *event) {
  if (event->notify_rx.attr_handle == newAlertHandle) {
    ...
    notif.category = Watch::Controllers::NotificationManager::Categories::SimpleAlert;
    notificationManager.Push(std::move(notif));

   // systemTask.PushMessage(Watch::System::SystemTask::Messages::OnNewNotification);
  }
}
