...
int MSCallback(uint16_t conn_handle, uint16_t attr_handle, struct ble_gatt_access_ctxt *ctxt, void *arg) {
  auto musicService = static_cast<Watch::Controllers::MusicService *>(arg);
  return musicService->OnCommand(conn_handle, attr_handle, ctxt);
}

Watch::Controllers::MusicService::MusicService(Watch::System::SystemTask &system) : m_system(system) {
...
void Watch::Controllers::MusicService::Init() {
  int res = 0;
...
int Watch::Controllers::MusicService::OnCommand(uint16_t conn_handle, uint16_t attr_handle,
...
std::string Watch::Controllers::MusicService::getAlbum() {
  return albumName;
}

std::string Watch::Controllers::MusicService::getArtist() {
  return artistName;
}

std::string Watch::Controllers::MusicService::getTrack() {
  return trackName;
}

bool Watch::Controllers::MusicService::isPlaying() {
  return playing;
}

float Watch::Controllers::MusicService::getPlaybackSpeed() {
  return playbackSpeed;
}

void Watch::Controllers::MusicService::event(char event) {
...
int Watch::Controllers::MusicService::getProgress() {
  return trackProgress;
}

int Watch::Controllers::MusicService::getTrackLength() {
  return trackLength;
}
