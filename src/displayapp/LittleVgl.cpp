...
LittleVgl::LittleVgl(Watch::Drivers::St7789& lcd, Watch::Drivers::Cst816S& touchPanel) : lcd{lcd}, touchPanel{touchPanel}, previousClick{0,0} {
  lv_init();
  InitTheme();
  InitDisplay();
  InitTouchpad();
...
void LittleVgl::InitBaseTheme() {
  if(font == nullptr) font = &San_Francisco_22;
...
lv_style_copy(&labelBigStyle, &prim);
  ...
  lv_style_copy(&labelSanStyle, &prim);
  labelSanStyle.text.font = &San_Francisco_22;
  LabelSanStyle = &(this->labelSanStyle);
