 ...
 */
Music::Music(Watch::Applications::DisplayApp *app, Watch::Controllers::MusicService &music) : Screen(app), musicService(music) {
  lv_obj_t *label;
...
bool Music::Refresh() {
  ...
  if (playing == Watch::Controllers::MusicService::MusicStatus::Playing) {
    lv_label_set_text(txtPlayPause, "||");
...
bool Music::OnTouchEvent(Watch::Applications::TouchEvents event) {
  switch (event) {
