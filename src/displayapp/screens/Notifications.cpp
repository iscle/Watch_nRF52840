...
Notifications::Notifications(DisplayApp *app, Watch::Controllers::NotificationManager &notificationManager, Modes mode) :
...
bool Notifications::OnTouchEvent(Watch::Applications::TouchEvents event) {
  switch (event) {
    case Watch::Applications::TouchEvents::SwipeUp: {
      ...
      return true;
    case Watch::Applications::TouchEvents::SwipeDown: {
