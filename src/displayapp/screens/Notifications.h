    ...
    namespace Screens {
      class Notifications : public Screen {
        public:
          ...
          explicit Notifications(DisplayApp* app, Watch::Controllers::NotificationManager& notificationManager, Modes mode);
          ~Notifications() override;

          bool Refresh() override;
          bool OnButtonPushed() override;
          bool OnTouchEvent(Watch::Applications::TouchEvents event) override;
