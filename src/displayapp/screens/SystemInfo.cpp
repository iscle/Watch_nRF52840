...
SystemInfo::SystemInfo(Watch::Applications::DisplayApp *app,
        ...
        Screen(app),
        dateTimeController{dateTimeController}, batteryController{batteryController}, bleController{bleController}, watchdog{watchdog},
        screens{app, {
...
bool SystemInfo::OnTouchEvent(Watch::Applications::TouchEvents event) {
